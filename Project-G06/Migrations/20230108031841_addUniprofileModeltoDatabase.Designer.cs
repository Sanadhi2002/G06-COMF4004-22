...
namespace ProjectG06.Migrations.WebApplication2Db
{
    ...
    [Migration("20230108031841_addUniprofileModeltoDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication2User", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("WebApplication2User");
                });
            ...
            modelBuilder.Entity("Project_G06.Models.Uni_FacultyModel", b =>
                {
                    b.HasOne("Project_G06.Models.UniProfileModel", "UniProfileModel")
                        .WithOne("UniFacultyModel")
                        .HasForeignKey("Project_G06.Models.Uni_FacultyModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
